    ...
    <div class="list-group-item">
        <div class="d-flex">
            ...
            if ($this->Dados['botao']['list_marca']) {
                ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'marcas/listar'; ?>" class="btn btn-outline-info btn-sm"><i class='fas fa-list d-block d-md-none fa-2x'></i> <span class='d-none d-md-block'>Listar</span></a>
                </div>
                <?php
            }
            ?>
