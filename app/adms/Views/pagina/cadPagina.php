    ...
    <div class="list-group-item">
        <div class="d-flex align-items-center bg-light pr-2 pl-2 border rounded shadow-sm">
            ...
            if ($this->Dados['botao']['list_pagina']) {
                ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'pagina/listar'; ?>" class="btn btn-outline-info btn-sm"><i class='fa-solid fa-list'></i></a>
                </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" class="was-validated" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="obs" class="form-control is-invalid editorCK" rows="3" id="editor" required><?php
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select name="lib_pub" id="lib_pub" class="form-control is-invalid" required>
                        <?php
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="adms_sits_pg_id" id="adms_sits_pg_id" class="form-control is-invalid" required>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <select name="adms_grps_pg_id" id="adms_grps_pg_id" class="form-control is-invalid" required>
                        <option value="">Selecione</option>
                        <?php
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="adms_tps_pg_id" id="adms_tps_pg_id" class="form-control is-invalid" required>
                        <option value="">Selecione</option>
                        <?php
            ...
            <input name="CadPagina" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
