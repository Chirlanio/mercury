        ...
        <div class="d-flex align-items-center bg-light pr-2 pl-2 border rounded shadow-sm">
            ...
            <span class="d-none d-md-block">
                ...
                if ($this->Dados['botao']['list_pagina']) {
                    echo "<a href='" . URLADM . "pagina/listar' class='btn btn-outline-info btn-sm'><i class='fas fa-list'></i></a> ";
                }
                if ($this->Dados['botao']['vis_pagina']) {
                    echo "<a href='" . URLADM . "ver-pagina/ver-pagina/{$valorForm['id']}' class='btn btn-outline-primary btn-sm'><i class='fa-solid fa-eye'></i></a> ";
                }
                ?>
            </span>
        </div>
