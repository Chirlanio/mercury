    ...
    <div class="list-group-item">
        ...
        <form method="POST" action="" enctype="multipart/form-data" class="was-validated">
            <div class="row">
                ...
                ?>" >
                       <?php
                       if ($_SESSION['ordem_nivac'] == SUPADMPERMITION || $_SESSION['ordem_nivac'] == DP) {
                           ?>
                ...
                <div class="col-md-9 order-md-1">
                    ...
                    <div class="border border-second rounded p-3 mb-3 shadow-sm">
                        ...
                        <?php if ($_SESSION['ordem_nivac'] == SUPADMPERMITION || $_SESSION['ordem_nivac'] == DP) { ?>
                            <div class="form-row">

                                <div class="form-group col-md-3">
                                    <label><span class="text-danger">*</span> Situação</label>
                                    <select name="adms_sits_personnel_mov_id" id="adms_sits_personnel_mov_id" class="custom-select is-invalid" required>
                                        <option value="">Selecione</option>
                                        <?php
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <div class="border border-second rounded p-3 shadow-sm">
                                <h6 class="mb-2"><span class="text-danger">*</span> Vínculo Contrato</h6>
                        ...
                        <div class="form-group col-md-6">
                            <div class="border border-second rounded h-100 p-3 shadow-sm">
                                <h6 class="mb-2"><span class="text-danger">*</span> Motivo</h6>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <div class="border border-second rounded p-3 shadow-sm">
                                <h6 class="mb-2"><span class="text-danger">*</span> Aviso Prévio</h6>
                                <div class="form-group d-block">
                                    <div class="custom-control custom-radio mr-2">
                    ...
                    <div class="form-row">
                        <div class="form-group col-12">
                            <div class="border border-second rounded p-3 shadow-sm">
                                <h6 class="mb-2">Motivo(s) do Desligamento:</h6>
                                <div class="d-flex">
                                    <div class="form-group col-12">
                                        <div class="d-flex p-2">
                                            <div class="form-group d-flex mr-2">
                                                <div class="form-group form-check">
                                                    <?php
                                                    $count = 1;
                                                    foreach ($this->Dados['select']['reasons'] as $reason) {//Recebe todos os motivos para o desligamento
                                                        extract($reason);
                                                        //var_dump($reason);
                                                        if (($order_reason === 1) && (!empty($this->Dados['reasons'])) ) {//Verifica a ordem dos motivos para impromir somente quando a ordem for igual a 1
                                                            foreach ($this->Dados['reasons'] as $ress) {//Recebe todos motivos registrados
                                                                extract($ress);
                                                                //var_dump($ress);
                                                                if ($count == 1 and $r_id == $adms_reason_dism_id) {
                                                                    ?>
                                                                    <div class="m-2">
                                                                        <input name="reasons[]" type="checkbox" id="<?php echo $r_id; ?>" class="form-check-input" value="<?php echo $r_id; ?>" <?php echo ($r_id == $adms_reason_dism_id) ? 'checked' : ""; ?>>
                                                                        <label class="form-check-label" for="<?php echo $r_id; ?>"><?php echo $question_reason; ?></label>
                                                                    </div>
                                                                    <?php
                                                                    $r_id == $adms_reason_dism_id ? $count++ : $count = 1;
                                                                }
                                                            }
                                                            if ($count == 1 and $r_id !== $adms_reason_dism_id) {
                                                                ?>
                                                        ...
                                                        ($r_id == $adms_reason_dism_id) && (!isset($adms_reason_dism_id)) ? $count++ : $count = 1;
                                                    }
                                                    ?>
                                                </div>
                                                ...
                                                <div class="form-group form-check">
                                                    ...
                                                    foreach ($this->Dados['select']['reasons'] as $reason) {
                                                        extract($reason);
                                                        if ($order_reason === 2) {
                                                            foreach ($this->Dados['reasons'] as $ress) {
                                                                extract($ress);
                                                                if ($countNew == 1 and $r_id == $adms_reason_dism_id) {
                                                                    ?>
                                                                    <div class="m-2">
                                                                        <input name="reasons[]" type="checkbox" id="<?php echo $r_id; ?>" class="form-check-input" value="<?php echo $r_id; ?>" <?php echo ($r_id == $adms_reason_dism_id) ? 'checked' : ""; ?>>
                                                                        <label class="form-check-label" for="<?php echo $r_id; ?>"><?php echo $question_reason; ?></label>
                                                                    ...
                                                                    <?php
                                                                    $r_id == $adms_reason_dism_id ? $countNew++ : $countNew = 1;
                                                                }
                                                            }
                                                            if ($countNew == 1 and $r_id !== $adms_reason_dism_id) {
                                                                ?>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <div class="border border-second rounded p-3 shadow-sm">
                                <h6><span class="text-danger">*</span> Observações</h6>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <div class="mb-3">
                                <ul class="border border-second rounded list-group mb-3 shadow-sm">
                                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                                        <div>
                            ...
                            <div class="border border-second rounded p-3 shadow-sm">
                                <h6 for="file_name" class="m-2">Arquivos</h6>
                                <input name="file_name[]" id="file_name" type="file" class="custom-file m-2" multiple>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <input name="EditMoviment" type="submit" class="btn btn-warning btn-submit" value="Salvar">
        </form>
    </div>
</div>
