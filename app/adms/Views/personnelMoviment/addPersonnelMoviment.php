    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Solicitar Movimentação de Pessoal</h2>
            </div>
            <?php
            if ($this->Dados['botao']['list_moviment']) {
                ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'personnel-moviments/list'; ?>" class="btn btn-outline-info btn-sm">Listar</a>
                </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data" class="was-validated">
            ...
            <input name="AddMoviment" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
