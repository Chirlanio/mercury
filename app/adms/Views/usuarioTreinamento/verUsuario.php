                ...
                <div class="p-2">
                    <span class="d-none d-md-block">
                        ...
                        if ($this->Dados['botao']['list_usuario']) {
                            echo "<a href='" . URLADM . "usuarios-treinamento/listar' class='btn btn-outline-info btn-sm' titlte='Listar'><i class='fa-solid fa-list'></i></a> ";
                        }
                        if ($this->Dados['botao']['edit_usuario']) {
                            echo "<a href='" . URLADM . "editar-usuario-treinamento/edit-usuario/$id' class='btn btn-outline-warning btn-sm' title='Editar'><i class='fa-solid fa-pen-to-square'></i></a> ";
                        }
                        if ($this->Dados['botao']['edit_senha']) {
                            echo "<a href='" . URLADM . "editar-senha-treinamento/edit-senha/$id' class='btn btn-outline-danger btn-sm' title='Editar senha'><i class='fa-solid fa-key'></i></a> ";
                        }
                        if ($this->Dados['botao']['del_usuario']) {
                            echo "<a href='" . URLADM . "apagar-usuario-treinamento/apagar-usuario/$id' class='btn btn-outline-danger btn-sm' data-confirm='Tem certeza de que deseja excluir o item selecionado?'><i class='fa-solid fa-eraser' title='Apagar'></i></a> ";
                        }
                        ?>
                    </span>
