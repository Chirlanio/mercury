    ...
    <div class="list-group-item">
        <div class="d-flex">
            ...
            if ($this->Dados['botao']['vis_usuario']) {
                ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'ver-usuario-treinamento/ver-usuario/' . $valorForm['id']; ?>" class="btn btn-outline-primary btn-sm"><i class="fa-solid fa-eye"></i> Visualizar</a>
                </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input name="usuario" type="text" class="form-control" placeholder="Como gostaria de ser chamado" value="<?php
            ...
            <div class="form-row">
                <div class="form-group col-md-2">
                    ...
                    <input name="cpf" type="text" class="form-control" id="cpf" placeholder="Digite o CPF" value="<?php
