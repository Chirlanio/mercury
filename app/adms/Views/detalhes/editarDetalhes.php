    ...
    <div class="list-group-item">
        <div class="d-flex align-items-center bg-light pr-2 pl-2 border rounded shadow-sm">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Editar Detalhes</h2>
            </div>
            <span class="d-none d-md-block">
                ...
                if ($this->Dados['botao']['vis_detalhes']) {
                    echo "<a href='" . URLADM . "ver-detalhes/ver-detalhes/{$valorForm['id']}' class='btn btn-outline-primary btn-sm'><i class='fa-solid fa-eye'></i></a> ";
                }
                ?>
            </span>
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            ...
            <input name="EditDetalhes" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
