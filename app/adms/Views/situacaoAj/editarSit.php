    ...
    <div class="list-group-item">
        <div class="d-flex align-items-center bg-light pr-2 pl-2 border rounded shadow-sm">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Editar Situações de Ajustes</h2>
            </div>
            <span class="d-none d-md-block">
                ...
                if ($this->Dados['botao']['vis_sit']) {
                    echo "<a href='" . URLADM . "ver-sit-aj/ver-sit/{$valorForm['id']}' class='btn btn-outline-primary btn-sm'><i class='fa-solid fa-eye'></i></a> ";
                }
                ?>
            </span>
        </div>
