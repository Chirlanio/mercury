        ...
        <div class="d-flex align-items-center bg-light pr-2 pl-2 border rounded shadow-sm">
            ...
            <div class="p-2">
                ...
                if ($this->Dados['botao']['cad_cor']) {
                    echo "<a href='" . URLADM . "cadastrar-cor/cad-cor' class='btn btn-outline-success btn-sm'><i class='fa-solid fa-square-plus'></i> Novo</a> ";
                }
                ?>
            </div>
        </div>
                            ...
                            <td class="text-center">
                                <span class="d-none d-md-block">
                                    ...
                                    if ($this->Dados['botao']['vis_cor']) {
                                        echo "<a href='" . URLADM . "ver-cor/ver-cor/$id' class='btn btn-outline-primary btn-sm' title='Visualizar'><i class='fas fa-eye'></i></a> ";
                                    }
                                    if ($this->Dados['botao']['edit_cor']) {
                                        echo "<a href='" . URLADM . "editar-cor/edit-cor/$id' class='btn btn-outline-warning btn-sm' title='Editar'><i class='fas fa-pen-nib'></i></a> ";
                                    }
                                    if ($this->Dados['botao']['del_cor']) {
                                        echo "<a href='" . URLADM . "apagar-cor/apagar-cor/$id' class='btn btn-outline-danger btn-sm' data-confirm='Tem certeza de que deseja excluir o item selecionado?' title='Apagar'><i class='fas fa-eraser'></i></a> ";
                                    }
                                    ?>
                                </span>
