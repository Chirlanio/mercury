            ...
            <div class="p-2 d-print-none">
                <span class="d-none d-md-block">
                    ...
                    if ($this->Dados['botao']['list_process']) {
                        echo "<a href='" . URLADM . "process-library/list' class='btn btn-outline-info btn-sm'><i class='fas fa-list'></i></a> ";
                    }
                    if ($this->Dados['botao']['view_process']) {
                        echo "<a href='" . URLADM . "view-process-library/process-library/" . $valorForm['pl_id'] . "' class='btn btn-outline-primary btn-sm'><i class='fas fa-eye'></i></a> ";
                    }
                    ?>
                </span>
