                    ...
                    <span class="d-none d-md-block">
                        ...
                        if ($this->Dados['botao']['edit_transf']) {
                            if (!empty($_SESSION['pesqOrigem'])) {
                                ...
                                echo "<a href='" . URLADM . "editar-transf/edit-transf/$id?destivo={$_SESSION['pesqDestino']}&pg={$this->Dados['pg']}' class='btn btn-outline-warning btn-sm' title='Editar'><i class='fas fa-pen-nib'></i></a> ";
