    ...
    <div class="list-group-item">
        <div class="d-flex align-items-center bg-light pr-2 pl-2 mb-4 border rounded shadow-sm">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Cadastro de Produtos</h2>
            </div>
        </div>
        <form class="form" method="POST" action="<?php echo URLADM . 'pesq-produtos/listar'; ?>" enctype="multipart/form-data">
            <div class="row">
                                ...
                                <td class="text-center align-middle">
                                    <span class="d-none d-md-block">
                                        ...
                                        if ($this->Dados['botao']['vis_produtos']) {
                                            echo "<a href='" . URLADM . "ver-produto/ver-produto/$referencia' class='btn btn-outline-primary btn-sm align-middle' title='Visualizar'><i class='fas fa-eye'></i></a> ";
                                        }
                                        ?>
                                    </span>
