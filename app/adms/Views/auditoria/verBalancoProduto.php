        ...
        <div class="list-group-item">
            ...
            <div class="content p1">
                ...
                <div class="img-media mb-3">
                    <?php echo "<img class='img-media img-thumbnail img-fluid' src='http://www.meiasola.com/powerbi/$referencia.jpg' alt='$referencia' />"; ?>
                </div>
                <form class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control bg-white" id="obs_justificativa" value="<?php echo $obs_justificativa; ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <?php
                        if (empty($img_um) and empty($img_um) and empty($img_um)) {
                            ...
                            if (!empty($img_um)) {
                                echo "<img class='imagem img-thumbnail' id='img_um' src='" . URLADM . "assets/imagens/balanco/$id/$img_um.jpg' />";
                            }
                            if (!empty($img_dois)) {
                                echo "<img class='imagem img-thumbnail' id='img_um' src='" . URLADM . "assets/imagens/balanco/$id/$img_dois.jpg' />";
                            }
                            if (!empty($img_tres)) {
                                echo "<img class='imagem img-thumbnail' id='img_um' src='" . URLADM . "assets/imagens/balanco/$id/$img_tres.jpg' />";
                            }
                        }
                        ?>
                    </div>
