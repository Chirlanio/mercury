        ...
        <div class="d-flex align-items-center bg-light pr-2 pl-2 border rounded shadow-sm">
            ...
            <span class="d-none d-md-block">
                ...
                if ($this->Dados['botao']['list_nivac']) {
                    echo "<a href='" . URLADM . "nivel-acesso/listar' class='btn btn-outline-info btn-sm'><i class='fas fa-list'></i></a> ";
                }
                if ($this->Dados['botao']['vis_nivac']) {
                    echo "<a href='" . URLADM . "ver-niv-ac/ver-niv-ac/{$valorForm['id']}' class='btn btn-outline-primary btn-sm'><i class='fa-solid fa-eye'></i></a> ";
                }
                ?>
            </span>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="adms_cor_id" id="adms_cor_id" class="form-control is-invalid" required>
                        ...
                        <?php
                        foreach ($this->Dados['select']['cor_id'] as $c) {
                            extract($c);
                            if ($valorForm['cor_id'] == $id_cor) {
