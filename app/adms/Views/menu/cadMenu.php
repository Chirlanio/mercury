    ...
    <div class="list-group-item">
        <div class="d-flex align-items-center bg-light pr-2 pl-2 border rounded shadow-sm">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Cadastrar Item de Menu</h2>
            </div>
            <?php
            if ($this->Dados['botao']['list_menu']) {
                ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'menu/listar'; ?>" class="btn btn-outline-info btn-sm"><i class='fa-solid fa-list'></i></a>
                </div>
                <?php
            }
            ?>
        ...
        <form method="POST" action="" class="was-validated" enctype="multipart/form-data">
            ...
            <input name="CadMenu" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
