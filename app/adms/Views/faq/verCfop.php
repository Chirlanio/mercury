                ...
                <div class="p-2">
                    <span class="d-none d-md-block">
                        ...
                        if ($this->Dados['botao']['list_cfop']) {
                            echo "<a href='" . URLADM . "cfop/listar' class='btn btn-outline-info btn-sm'><i class='fa-solid fa-list'></i></a> ";
                        }
                        if ($this->Dados['botao']['edit_cfop']) {
                            echo "<a href='" . URLADM . "editar-cfop/edit-cfop/$id' class='btn btn-outline-warning btn-sm'><i class='fa-solid fa-pen-to-square'></i></a> ";
                        }
                        if ($this->Dados['botao']['del_cfop']) {
                            echo "<a href='" . URLADM . "apagar-cfop/apagar-cfop/$id' class='btn btn-outline-danger btn-sm' data-confirm='Tem certeza de que deseja excluir o item selecionado?'><i class='fa-solid fa-eraser'></i></a> ";
                        }
                        ?>
                    </span>
