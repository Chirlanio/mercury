                ...
                <div class="p-2">
                    <span class="d-none d-md-block">
                        ...
                        if ($this->Dados['botao']['list_dash']) {
                            echo "<a href='" . URLADM . "dashboard/listar' class='btn btn-outline-info btn-sm'><i class='fa-solid fa-list'></i></a> ";
                        }
                        if ($this->Dados['botao']['edit_dash']) {
                            echo "<a href='" . URLADM . "editar-dashboard/edit-dashboard/$id' class='btn btn-outline-warning btn-sm'><i class='fa-solid fa-pen-to-square'></i></a> ";
                        }
                        if ($this->Dados['botao']['del_dash']) {
                            echo "<a href='" . URLADM . "apagar-dashboard/apagar-dashboard/$id' class='btn btn-outline-danger btn-sm' data-confirm='Tem certeza de que deseja excluir o item selecionado?'><i class='fa-solid fa-eraser'></i></a> ";
                        }
                        ?>
                    </span>
