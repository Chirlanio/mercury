...
/**
 * Description of ViewSupplyCheckList
 *
 * @copyright (c) year, Chirlanio Silva - Grupo Meia Sola
 */
class ViewSupplyCheckList {
    ...
    public function checkList(string $DadosId = null) {
        ...
        if (!empty($this->DadosId)) {
            ...
            $viewCheckList = new \App\adms\Models\AdmsViewSupplyCheckList();
            ...
            $listSelect = new \App\adms\Models\AdmsViewSupplyCheckList();
            $this->Dados['select'] = $listSelect->listAdd($this->DadosId);

            $totalPoints = new \App\adms\Models\AdmsViewSupplyCheckList();
            $this->Dados['totalPoints'] = $totalPoints->totalQuestions($this->DadosId);

            $carregarView = new \Core\ConfigView("adms/Views/supplyCheckList/viewCheckList", $this->Dados);
