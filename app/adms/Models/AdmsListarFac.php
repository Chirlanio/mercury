...
class AdmsListarFac {
    ...
    public function listar($PageId = null) {
        ...
        $paginacao = new \App\adms\Models\helper\AdmsPaginacao(URLADM . 'fac/listar');
        $paginacao->condicao($this->PageId, $this->LimiteResultado);
        $paginacao->paginacao("SELECT COUNT(id) AS num_result FROM adms_faqs WHERE adms_sit_id =:adms_sit_id", "adms_sit_id=1");
