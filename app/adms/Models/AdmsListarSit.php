...
class AdmsListarSit {
    ...
    public function listarSit($PageId = null) {
        ...
        $listarSit->fullRead("SELECT sit.*, cr.cor cor_cr FROM adms_sits sit INNER JOIN adms_cors cr ON cr.id=sit.adms_cor_id ORDER BY sit.nome ASC LIMIT :limit OFFSET :offset", "limit={$this->LimiteResultado}&offset={$paginacao->getOffset()}");
