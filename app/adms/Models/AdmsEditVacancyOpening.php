...
class AdmsEditVacancyOpening {
    ...
    public function viewVacancy($DadosId) {
        ...
        if ($_SESSION['ordem_nivac'] <= FINANCIALPERMITION or $_SESSION['ordem_nivac'] == 16) {
    ...
    public function listAdd() {
        ...
        $listar->fullRead("SELECT id c_id, nome cargo_name FROM tb_cargos WHERE adms_sit_id =:adms_sit ORDER BY nome ASC", "adms_sit=1");
