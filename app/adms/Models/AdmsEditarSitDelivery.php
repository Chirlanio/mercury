...
/**
 * Description of AdmsEditarSitDelivery
 *
 * @copyright (c) year, Chirlanio Silva - Grupo Meia Sola
 */
class AdmsEditarSitDelivery {
    ...
    public function verSit($DadosId) {
        ...
        $verSit->fullRead("SELECT * FROM tb_status_delivery
    ...
    private function updateEditSit() {
        ...
        $upAltSit->exeUpdate("tb_status_delivery", $this->Dados, "WHERE id =:id", "id=" . $this->Dados['id']);
