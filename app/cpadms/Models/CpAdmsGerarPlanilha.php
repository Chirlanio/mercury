...
class CpAdmsGerarPlanilha {
    ...
    public function listar($PageId = null) {
        ...
        $listarCargo->fullRead("SELECT d.id id_loja, d.loja_id, d.func_id, d.cliente, d.endereco, d.bairro_id, d.rota_id, d.contato, d.valor_venda, d.forma_pag_id,
                d.parcelas, d.maq, d.ped_id, d.obs, d.qtde_produto, d.troca, d.ponto_saida, d.status_id, d.created, d.modified,
                ...
                INNER JOIN tb_status_delivery t ON t.id=d.status_id INNER JOIN tb_ponto_saida ls ON ls.id=d.ponto_saida INNER JOIN tb_bairros b ON b.id=d.bairro_id INNER JOIN tb_rotas r ON r.id=b.rota_id INNER JOIN adms_cors c ON c.id=r.adms_cor_id INNER JOIN tb_forma_pag fp ON fp.id=d.forma_pag_id
