...
//var_dump($valorForm);
?>
<form method="POST" class="was-validated" id="edit_form" enctype="multipart/form-data"> 
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input name="nome" id="nome" type="text" class="form-control" placeholder="Digite o nome completo" value="<?php
        ...
        <div class="form-group col-md-6">
            ...
            <input name="apelido" id="apelido" type="text" class="form-control" placeholder="Como gostaria de ser chamado" value="<?php
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input name="email" id="email" type="text" class="form-control" placeholder="Seu melhor e-mail" value="<?php
        ...
        <div class="form-group col-md-4">
            ...
            <input name="usuario" id="usuario" type="text" class="form-control" id="nome" placeholder="Digite o usuário" value="<?php
    ...
    <input name="EditUsuario" id="EditUsuario" type="submit" class="btn btn-warning" value="Salvar">
</form>