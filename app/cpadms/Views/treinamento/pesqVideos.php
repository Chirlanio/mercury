...
<div class="content p-1">
    <div class="list-group-item">
            ...
            <div class="p-2">
                <span class="d-none d-md-block">
                    ...
                    if ($this->Dados['botao']['list_video']) {
                        echo "<a href='" . URLADM . "escola-digital/listar-videos' class='btn btn-outline-info btn-sm'>Listar</a> ";
                    }
                    if ($this->Dados['botao']['cad_video']) {
                        echo "<a href='" . URLADM . "cadastrar-video/cad-video' class='btn btn-outline-success btn-sm'>Cadastrar</a> ";
                    }
                    ?>
                </span>
                <div class="dropdown d-block d-md-none">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar"> 
                        ...
                        if ($this->Dados['botao']['cad_video']) {
                            echo "<a class='dropdown-item' href='" . URLADM . "cadastrar-video/cad-video'>Cadastrar</a>";
                        }
                        ?>
                    </div>
                </div>
        ...
        <form class="form d-print-none" method="POST" action="" enctype="multipart/form-data"> 
            <div class="row">
        ...
        <div>
            ...
            <div class="card-deck mb-2 row row-cols-1 row-cols-md-3">
                <?php
                if (isset($this->Dados['listVideo']) AND!empty($this->Dados['listVideo'])) {
                    foreach ($this->Dados['listVideo'] as $video) {
                        extract($video);
                        ?>
