            ...
            <div class="p-2">
                <span class="d-none d-md-block">
                    ...
                    if ($this->Dados['botao']['list_usuario']) {
                        echo "<a href='" . URLADM . "usuarios-treinamento/listar' class='btn btn-outline-info btn-sm'>Listar</a> ";
                    }
                    if ($this->Dados['botao']['cad_usuario']) {
                        echo "<a href='" . URLADM . "cadastrar-usuario-treinamento/cad-usuario' class='btn btn-outline-success btn-sm'>Cadastrar</a> ";
                    }
                    ?>
                </span>
                <div class="dropdown d-block d-md-none">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar"> 
                        ...
                        if ($this->Dados['botao']['cad_usuario']) {
                            echo "<a class='dropdown-item' href='" . URLADM . "cadastrar-usuario-treinamento/cad-usuario'>Cadastrar</a>";
                        }
                        ?>
                    </div>
                </div>
