    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Pesquisar Pedidos de Faturamento</h2>
            </div>
            <div class="p-2">
                <span class="d-none d-md-block">
                    ...
                    if ($this->Dados['botao']['add_ecommerce_order']) {
                        echo "<a href='" . URLADM . "add-ecommerce-order/add-order' class='btn btn-outline-success btn-sm'>Cadastrar</a> ";
                    }
                    ?>
                </span>
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12 mb-4">
                    <div class="input-group">
                        ...
                        <input name="search" type="text" id="search" class="form-control" aria-describedby="search" placeholder="Pesquise por loja, situação ou ID" value="<?php
        ...
        <?php
        if (empty($this->Dados['list_ecommerce'])) {
            ?>
            <div class="alert alert-danger" role="alert">
                Nenhum pedido de faturamento encontrado!
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?php
            $redirectUrl = URLADM . 'ecommerce/list';
            if (empty($this->Dados['list_ecommerce'])) {
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    <?php
                    foreach ($this->Dados['list_ecommerce'] as $ecommerce) {
                        extract($ecommerce);
                        ?>
                    <th><?php echo $id; ?></th>
