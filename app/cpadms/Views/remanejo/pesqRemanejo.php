            ...
            <div class="p-2">
                <span class="d-none d-md-block">
                    ...
                    if ($this->Dados['botao']['list_remanejo']) {
                        echo "<a href='" . URLADM . "remanejo/listar' class='btn btn-outline-info btn-sm'>Listar</a> ";
                    }
                    if ($this->Dados['botao']['cad_remanejo']) {
                        echo "<a href='" . URLADM . "cadastrar-remanejo/cad-remanejo' class='btn btn-outline-success btn-sm'>Cadastrar</a> ";
                    }
                    ?>
                </span>
