                    ...
                    if ($this->Dados['botao']['gerar']) {
                        switch (isset($_SESSION['search']) AND (!empty($_SESSION['search']))) {
                            ...
                            case 26:
                                ...
                                break;
                            case 27:
                                echo "<a href='" . URLADM . "gerar-planilha/gerar?situacao={$this->Dados['search']['sit_id']}' class='btn btn-success btn-sm'><i class='fa-solid fa-table'></i> Gerar Excel</a> ";
                                break;
                            case 28:
                                echo "<a href='" . URLADM . "gerar-planilha/gerar?cliente={$this->Dados['search']['cliente']}' class='btn btn-success btn-sm'><i class='fa-solid fa-table'></i> Gerar Excel</a> ";
                                break;
                            default:
